...
interface StartWindowDragOptions {
  ...
  /// Recording and Processing pills hold a Stop button, a Retry button, a
  /// provider Select and a Generate Summary button): mousedown bubbles, so
  /// without this guard pressing any of them would be swallowed into a window
  /// drag instead of reaching the control. Surfaces whose children are purely
  /// decorative (the TitleBar's grip dots) leave this off, or pressing a dot
  /// -- dead centre of the title bar -- would not drag the window.
