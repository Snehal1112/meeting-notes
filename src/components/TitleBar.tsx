...
export function TitleBar({ onOpenSettings }: TitleBarProps) {
  return (
    <div
      ...
      // The settings and close buttons are real interactive children now, so
      // a press on either must not be swallowed into a window drag -- see
      // requireSelfTarget in startWindowDrag, same reasoning as the
      // Stop/Retry buttons inside the Recording/Processing pills.
